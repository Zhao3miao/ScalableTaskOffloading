...
# ============================================================
# Deterministic uniform split diagnostic baseline
# Usage: bash uniform_split.sh <seed>
# Testing on Subway Station scales
# ============================================================

SEED=${1:?"Usage: bash uniform_split.sh <seed>"}
EXP="experiment_seed_${SEED}"
METHOD="uniform_split"
MODEL="uniform_split_subway50"
...
echo "All UNIFORM_SPLIT subway diagnostics done for seed=${SEED}."
