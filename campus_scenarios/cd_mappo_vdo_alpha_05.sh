...
# ============================================================
# CD-MAPPO vdo_alpha probe: vdo_alpha=0.5
# Usage: bash cd_mappo_vdo_alpha_05.sh <seed>
# Training on campus UE=50, testing across campus scales
# Results are saved separately from the default CD-MAPPO run.
# ============================================================

SEED=${1:?"Usage: bash cd_mappo_vdo_alpha_05.sh <seed>"}
EXP="experiment_seed_${SEED}"
VDO_ALPHA=0.5
METHOD="cd_mappo_vdo_alpha_05"
