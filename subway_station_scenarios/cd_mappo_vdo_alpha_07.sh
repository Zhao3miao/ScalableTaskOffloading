...
# ============================================================
# CD-MAPPO vdo_alpha probe: vdo_alpha=0.7
# Usage: bash cd_mappo_vdo_alpha_07.sh <seed>
# Training on Subway Station UE=50, testing across subway scales
# Results are saved separately from the default CD-MAPPO run.
# ============================================================

SEED=${1:?"Usage: bash cd_mappo_vdo_alpha_07.sh <seed>"}
EXP="experiment_seed_${SEED}"
VDO_ALPHA=0.7
METHOD="cd_mappo_vdo_alpha_07"
MODEL_NAME="${METHOD}_subway50"
SAVE_DIR="./${EXP}/${METHOD}"
...
run_test subway_station_scenarios/subway_station_max_ue_30
run_test subway_station_scenarios/subway_station_max_ue_50
run_test subway_station_scenarios/subway_station_max_ue_80
run_test subway_station_scenarios/subway_station_max_ue_100
run_test subway_station_scenarios/subway_station_max_ue_120 120
run_test subway_station_scenarios/subway_station_max_ue_150 150
run_test subway_station_scenarios/subway_station_max_ue_200 200
