...
# ============================================================
# CD-MAPPO vdo_alpha probe: vdo_alpha=0.3
# Usage: bash cd_mappo_vdo_alpha_03.sh <seed>
# Training on Subway Station UE=50, testing across subway scales
# Results are saved separately from the default CD-MAPPO run.
# ============================================================

SEED=${1:?"Usage: bash cd_mappo_vdo_alpha_03.sh <seed>"}
EXP="experiment_seed_${SEED}"
VDO_ALPHA=0.3
METHOD="cd_mappo_vdo_alpha_03"
